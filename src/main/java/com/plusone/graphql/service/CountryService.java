...
import static com.plusone.graphql.service.PagingUtility.preparePageInfo;
...
public class CountryService {
    ...
    public Country createCountry(@GraphQLArgument(name = "countryInput", description = "The country object") @GraphQLNonNull @Valid CountryInput countryInput) {
