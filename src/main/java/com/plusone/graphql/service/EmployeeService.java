package com.plusone.graphql.service;
...
import com.plusone.graphql.dto.EmployeesPaginated;
import com.plusone.graphql.dto.Employee;
import com.plusone.graphql.dto.PageData;
import com.plusone.graphql.dto.input.EmployeeInput;
import com.plusone.graphql.entity.EmployeeEntity;
import com.plusone.graphql.exception.ResourceNotFoundException;
import com.plusone.graphql.mappers.DepartmentMapper;
import com.plusone.graphql.repository.DepartmentRepository;
import com.plusone.graphql.repository.EmployeeRepository;
import com.plusone.graphql.repository.EntityGraphSelectorUtil;
...
import static com.plusone.graphql.service.PagingUtility.validateSortField;
...
public class EmployeeService {
    ...
    public Employee addEmployee(@GraphQLArgument(name = "departmentId", description = "Specify id of the department to which the employee to be added") @GraphQLNonNull @GraphQLId Long departmentId, @GraphQLArgument(name = "employeeInput", description = "The input employee object") @GraphQLNonNull @Valid EmployeeInput empInput) {
